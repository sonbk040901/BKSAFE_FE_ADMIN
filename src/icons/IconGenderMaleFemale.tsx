// icon:gender-male-female | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";

function IconGenderMaleFemale(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconGenderMaleFemale;
